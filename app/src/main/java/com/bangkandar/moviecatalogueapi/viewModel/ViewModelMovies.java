package com.bangkandar.moviecatalogueapi.viewModel;
...
import com.bangkandar.moviecatalogueapi.BuildConfig;
...
public class ViewModelMovies extends ViewModel {
    ...
    public void setMovies(final String EXTRA_MOVIE) {
        ...
        String url = "http://api.themoviedb.org/3/movie/upcoming?api_key=" + apiKey + "&language=en-US";
